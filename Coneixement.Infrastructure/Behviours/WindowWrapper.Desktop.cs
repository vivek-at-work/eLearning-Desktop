...
namespace Coneixement.Infrastructure.Behaviors
{
    /// <summary>
    ...
    public class WindowWrapper : IWindow
    {
        ...
        public WindowWrapper()
        {
            ...
            window.Icon = new System.Windows.Media.Imaging.BitmapImage(new Uri("pack://application:,,,/Coneixement.Infrastructure;component/Images/ikon logo copy-1.jpg"));
        ...
        {
            if(window.Content as UserControl!=null)
            if ((window.Content as UserControl).ActualHeight > SystemParameters.PrimaryScreenHeight - 100)
            {
